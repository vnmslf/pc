( function( $ ) {
	...
	$('.accordion-start').each(function() {
		var _this = $(this),
			activeText = _this.attr('data-active-text') || '',
			inactiveText = _this.attr('data-inactive-text') || '',
			activeClass = _this.attr('data-active-class') || '',
			inactiveClass = _this.attr('data-inactive-class') || '';
		$('.collapse', this).on('show.bs.collapse', function () {
			var id = $(this).attr('id');
			$('a[href="#' + id + '"]').closest('.panel-heading').addClass('active-accordion');
			$('a[href="#' + id + '"]').text(activeText);
			$('a[href="#' + id + '"]').addClass(activeClass).removeClass(inactiveClass);
		}).on('hide.bs.collapse', function() {
			var id = $(this).attr('id');
			$('a[href="#' + id + '"]').closest('.panel-heading').removeClass('active-accordion');
			$('a[href="#' + id + '"]').text(inactiveText);
			$('a[href="#' + id + '"]').addClass(inactiveClass).removeClass(activeClass);
		});
	});

	$('.check_in').each(function() {
		$(this).click(function() {
			if($(this).find('.check_out').prop('checked') === true) {
				$(this).find('.check_out').prop('checked', false);
			} else {
				$(this).find('.check_out').prop('checked', true);
			}
		})
	});
